    ...
    def gr_models(self, x, y):
        ...
        for w in self.windows:
            ...
            for i in range(self.n_gr_trees):
                self.gr_trees[w].append(self.rf(grained_x, grained_y, {'n_estimators': 10, 'max_depth': 3, 'n_jobs': 4}))
                self.gr_trees[w].append(self.rf(grained_x, grained_y, {'n_estimators': 10, 'max_depth': 5, 'n_jobs': 4}))
                # self.gr_trees[w].append(self.xgb(grained_x, grained_y, {'n_estimators': 300, 'max_depth': 3, 'n_jobs': 4}))
                # self.gr_trees[w].append(self.xgb(grained_x, grained_y, {'n_estimators': 300, 'max_depth': 5, 'n_jobs': 4}))
    ...
    def ca_models(self, y):
        ...
        for i, w in enumerate(self.windows):
            ...
            for j in range(self.n_ca_trees): ## 2
                self.ca_trees[self.n_layers][w].append(self.rf(ca_input, y, {'n_estimators': 10, 'max_depth':3, 'n_jobs': 4}))
                self.ca_trees[self.n_layers][w].append(self.rf(ca_input, y, {'n_estimators': 10, 'max_depth':5, 'n_jobs': 4}))
                # self.ca_trees[self.n_layers][w].append(self.xgb(ca_input, y, {'n_estimators': 300, 'max_depth':3, 'n_jobs': 4}))
                # self.ca_trees[self.n_layers][w].append(self.xgb(ca_input, y, {'n_estimators': 300, 'max_depth':5, 'n_jobs': 4}))
